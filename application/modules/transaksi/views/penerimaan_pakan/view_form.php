<div class="form-group d-flex align-items-center">
    <div class="col-lg-6 d-flex align-items-center no-padding">
        ...
        <div class="col-lg-6">
            <label class="control-label">: <?php echo $data['kirim_pakan']['no_sj']; ?></label>
        </div>
    </div>
</div>
<div class="form-group d-flex align-items-center">
    <div class="col-lg-6 d-flex align-items-center no-padding">
        ...
        <div class="col-lg-4">
            <label class="control-label">: <?php echo strtoupper($data['kirim_pakan']['jenis_kirim']); ?></label>
        </div>
    </div>
    <div class="col-lg-6 d-flex align-items-center no-padding">
        <div class="col-lg-3 text-left">No. Order</div>
        <div class="col-lg-4">
            <label class="control-label">: <?php echo $data['kirim_pakan']['no_order']; ?></label>
        </div>
    </div>
</div>
<div class="form-group d-flex align-items-center">
    <div class="col-lg-6 d-flex align-items-center no-padding">
        ...
        <div class="col-lg-4">
            <label class="control-label">: <?php echo strtoupper(tglIndonesia($data['kirim_pakan']['tgl_kirim'], '-', ' ', true)); ?></label>
        </div>
    </div>
    <div class="col-lg-6 d-flex align-items-center no-padding">
...
<div class="form-group d-flex align-items-center">
    <div class="col-lg-6 d-flex align-items-center no-padding">
        ...
        <div class="col-lg-4">
            <label class="control-label">: <?php echo $data['kirim_pakan']['no_polisi']; ?></label>
        </div>
    </div>
</div>
<div class="form-group d-flex align-items-center">
    <div class="col-lg-6 d-flex align-items-center no-padding">
        ...
        <div class="col-lg-8">
            <label class="control-label">: <?php echo $data['kirim_pakan']['ekspedisi']; ?></label>
        </div>
    </div>
</div>
<div class="form-group d-flex align-items-center">
    <div class="col-lg-6 d-flex align-items-center no-padding">
        ...
        <div class="col-lg-4">
            <label class="control-label">: <?php echo $data['kirim_pakan']['sopir']; ?></label>
        </div>
    </div>
</div>
<div class="form-group d-flex align-items-center">
