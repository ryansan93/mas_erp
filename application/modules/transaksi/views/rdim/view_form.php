					...
					<?php foreach ($data['rdim_submit']['status-1'] as $perwakilan_id => $rs): ?>
						...
						<?php foreach ($rs['details'] as $detail): ?>
							<tr class="child" data-key="<?php echo $perwakilan_id ?>" data-id="<?php echo $detail['id'] ?>">
								...
								<td class="page2">
									<a class="cursor-p" onclick="rdim.formPenanggungJawabKandang(this)" data-id="<?php echo $detail['id']; ?>"><?php echo $detail['pengawas'] ?></a>
								</td>
								<td class="page2">
									<a class="cursor-p" onclick="rdim.formPenanggungJawabKandang(this)" data-id="<?php echo $detail['id']; ?>"><?php echo $detail['sampling'] ?></a>
								</td>
								<td class="page2">
									<a class="cursor-p" onclick="rdim.formPenanggungJawabKandang(this)" data-id="<?php echo $detail['id']; ?>"><?php echo $detail['tim_panen'] ?></a>
								</td>
								<td class="page2">
									<a class="cursor-p" onclick="rdim.formPenanggungJawabKandang(this)" data-id="<?php echo $detail['id']; ?>"><?php echo $detail['koar'] ?></a>
								</td>
