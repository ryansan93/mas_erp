...
<div style="font-size:12px; font-style:Calibri;">
			...
			<table>
				<tbody>
					<tr style="page-break-after: always;">
						...
						<td>: <?php echo strtoupper($data['periode']); ?></td>
					</tr>
					<tr style="page-break-after: always;">
					...
					<tr style="page-break-after: always;">
						...
						<td>: <?php echo strtoupper($data['ktp']); ?></td>
					</tr>
					<tr style="page-break-after: always;">
					...
					<tr style="page-break-after: always;">
						...
						<td>: <?php echo strtoupper($data['alamat_kdg']); ?></td>
					</tr>
					<tr style="page-break-after: always;">
