	            			...
	            			<div class="col-sm-12 no-padding <?php echo $hide_inti; ?>">
	            				<?php if ( $data['cn'] == '' ): ?>
				            		<div class="col-sm-12 d-flex align-items-center">
				            			<div class="col-sm-1 d-flex align-items-center no-padding"><label class="control-label">CN : </label></div>
				            			<div class="col-sm-4">
				            			...
				            			<div class="col-sm-2">
				            				<button type="button" class="btn btn-primary" onclick="tsdrhpp.submitCn(this)" data-noreg="<?php echo $data['noreg']; ?>" data-id="<?php echo $data['id'] ?>">Submit CN</button>
				            			</div>
				            		</div>	            					
	            				<?php endif ?>
	            			</div>
