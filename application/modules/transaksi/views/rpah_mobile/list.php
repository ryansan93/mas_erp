<?php if ( !empty($data) && count($data) > 0 ): ?>
	<?php foreach ($data as $k_data => $v_data): ?>
		<tr class="cursor-p" onclick="rm.changeTabActive(this)" data-tglpanen="<?php echo $v_data['tgl_panen']; ?>" data-noreg="<?php echo $v_data['noreg']; ?>" data-nomor="<?php echo $v_data['nomor']; ?>" data-edit="" data-href="transaksi">
