					...
					<div id="pakan" class="tab-pane fade">
						<?php if ( $akses['a_submit'] == 1 ): ?>
							<div class="col-lg-8 search no-padding d-flex align-items-center">
								...
								<div class="col-sm-2">
									<button id="btn-tampil" type="button" data-href="action" class="btn btn-primary cursor-p pull-left" title="TAMPIL" onclick="odvp.get_lists_pakan()">Tampilkan</button>
								</div>
								<div class="col-sm-2">
									<button id="btn-add" type="button" data-href="action" class="btn btn-primary cursor-p pull-left" title="ADD" onclick="odvp.order_pakan_form()"><i class="fa fa-plus" aria-hidden="true"></i> ADD</button>
								</div>
							</div>
							<div class="col-lg-4 action no-padding">
								<div class="col-lg-4 search left-inner-addon no-padding pull-right" style="margin-left: 10px;">
							...
							<table class="table table-bordered table-hover tbl_odvp" id="dataTable" width="100%" cellspacing="0">
								<thead>
									<tr class="v-center">
										...
										<th class="text-center col-sm-3">Supplier</th>
								...
								<tbody class="list">
									<tr>
										<td class="text-left" colspan="8">Data tidak ditemukan.</td>
									</tr>
								</tbody>
							</table>
						<?php else: ?>
