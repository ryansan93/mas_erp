...
<div class="col-xs-12 no-padding">
	...
	<?php
		$unit = null;
		if ( !empty($data['d_unit']) ) {
			$unit = str_replace('kab ', '', $data['d_unit']['nama']);
...
<div class="col-xs-12 no-padding">
	...
	<div class="col-xs-1 no-padding text-center" style="max-width: 2%;"><label class="control-label">:</label></div>
	<div class="col-xs-10 no-padding"><label class="control-label"><?php echo strtoupper($data['perusahaan']); ?></label></div>
</div>
